...
> スマホを置くと、犬や猫が育つ。30種いじょうの いぬねこ図鑑をコンプリートしよう。やさしいデジタルデトックス。
...
■ 30種いじょうの図鑑 — 柴犬からベンガルまで。レアな子に出会って図鑑をうめよう
■ れんぞく成功ボーナス — 毎日つづけるほど、ごほうびアップ
■ 完全無料・広告なし・登録不要 — データはぜんぶ端末の中だけ。やさしい設計です
...
- 30+ breeds to collect, from Shiba Inu to Bengal
- Streak bonuses for daily success
- Free, no ads, no sign-up. All data stays on your device.

## スクリーンショット構成案（6.7" / 6.5" / 5.5" とAndroid共通）

1. ホーム画面（ペット＋ステータス）「スマホを置くと、育つ。」
2. おさんぽ中画面「30分・1時間・2時間のデトックス」
3. おさんぽ成功モーダル「がまんできたら、ごほうび」
4. 図鑑画面「30種いじょうをコンプリート」
5. 孵化演出「つぎは、どの子？」
