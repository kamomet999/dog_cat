 ...
 * tier     : 省略=無料（メジャー各15種）／ 'premium'=¥500課金で解放
 *
 * 課金モデル（ユーザー決定 2026-07-07 改訂。docs/MONETIZATION.md が正）:
 *   収録は全60種＝犬30・猫30（全種スプライト絵つき。品質優先で400種構想から縮小）。
 *   無料 = 人気メジャー各15種（tier 無し）。¥500買い切りで残り各15種（tier: 'premium'）を解放。
...
(function (global) {
  ...
  var BREEDS = [
    ...
    {
      id: 'bulldog', species: 'dog', name: 'ブルドッグ', rarity: 'rare', nature: 'のんびりや', tier: 'premium',
      desc: 'どっしり貫禄、しわが魅力。',
    ...
    {
      id: 'kurolab', species: 'dog', name: '黒ラブラドール', rarity: 'common', nature: 'おりこう', tier: 'premium',
    ...
    {
      id: 'jackrussell', species: 'dog', name: 'ジャックラッセル', rarity: 'uncommon', nature: 'げんきいっぱい', tier: 'premium',
      desc: '小さな体に あふれる元気。やんちゃ大将。',
      art: { base: 'dog', ear: 'flop', color: '#fbf6ee', color2: '#c98a4f', pattern: 'patch', eye: '#2a1d12', fluffy: false }
    },
    {
      id: 'schnauzer', species: 'dog', name: 'シュナウザー', rarity: 'uncommon', nature: 'おりこう', tier: 'premium',
      desc: 'りっぱな おひげが トレードマーク。',
      art: { base: 'dog', ear: 'prick', color: '#8a8580', color2: '#c8c2b8', pattern: 'solid', eye: '#2a1d12', fluffy: true }
    },
    {
      id: 'yorkie', species: 'dog', name: 'ヨークシャテリア', rarity: 'uncommon', nature: 'きれいずき', tier: 'premium',
